...
class TokenTracker {
  ...
  /**
   * Track tokens from Claude Code CLI response format
   * @param {Object} claudeResponse - Response from Claude CLI with usage data
   */
  trackClaudeCodeResponse(claudeResponse) {
    if (claudeResponse && claudeResponse.usage) {
      this.addTokens(
