...
> [!IMPORTANT]  
> **New**: Use Graphiti with local Claude Docker instances! See [Claude Docker Integration](README_GRAPHITI_CLAUDE_DOCKER.md) for complete Islamic text analysis platform integration.
