...
class ClaudeAgentWrapper {
  constructor(agentName, port, systemPrompt) {
    this.agentName = agentName;
    this.port = port;
    this.systemPrompt = systemPrompt;
    
    // NOTE: Claude Code CLI handles authentication via session-based patterns
    // No direct Anthropic API key needed - conflicts with claude-docker patterns
    this.anthropic = null; // Will use Claude Code CLI instead
