...
app.get('/health', (req, res) => {
  res.json({ 
    ...
    status: 'active',
    mission: 'Transform mapper research into culturally sensitive library catalog fields',
    methodology: 'Quality-focused Research-to-Catalog Transformation with Islamic Scholarly Framework',
    ...
    cultural_sensitivity: 'Adab al-Ilm (Etiquette of Knowledge) principles applied',
...
async function synthesizeContent(title, authorName, reservoirId) {
  ...
  try {
    ...
    const systemPrompt = `You are an expert Islamic library catalog synthesizer specializing in transforming scholarly research into high-quality library catalog fields with cultural sensitivity and academic precision. Your expertise includes:
...
**Core Competencies:**
- Library science and Islamic catalog field optimization
- Traditional Islamic knowledge classification systems (Fiqh, Hadith, Tafsir, Aqeedah)
- Culturally sensitive keyword extraction and search optimization
- Respectful description writing that honors Islamic scholarship
- Accurate title translation preserving scholarly context
- Academic level assessment within Islamic learning progression

**Cultural Sensitivity Guidelines:**
- Use respectful language when describing Islamic concepts
- Preserve Arabic terminology with proper context
- Acknowledge sectarian differences without bias (Sunni, Shia, Sufi traditions)
- Maintain scholarly dignity in all descriptions
- Ensure accurate representation of Islamic traditions and methodologies

Your mission is to transform mapper research into high-quality library catalog fields: categories, keywords, description, and title_alias.

Return structured JSON with these exact fields:
{
  "agent": "enhanced_content_synthesizer",
  "generated_at": "[ISO timestamp]",
  "synthesis_mission": "Quality-focused transformation of mapper research into culturally sensitive library catalog fields",
  "analysis_method": "claude_code_library_synthesis",
  
  "categories": [
    "Primary Islamic Discipline (Fiqh, Hadith, Tafsir, Aqeedah)",
    "Sub-Genre within Islamic Tradition",
  ...
  "description": "Thoughtful summary (75-150 words) that introduces the work with appropriate respect, explains significance in Islamic scholarship, and preserves scholarly dignity while ensuring accessibility",
  
  "title_alias": "Culturally sensitive English translation or alternative that maintains scholarly authenticity while improving searchability",
...
Focus on creating library catalog fields that honor Islamic scholarship while serving both specialists and general users with cultural sensitivity and academic precision.`;

    // Create the synthesis prompt
    const synthesisPrompt = `Transform the following Islamic text mapper research into high-quality library catalog fields with cultural sensitivity and scholarly precision:
...
Please synthesize this research into culturally sensitive library catalog fields:
1. Categories: 3-6 Islamic scholarly classifications based on traditional knowledge systems
2. Keywords: 15-30 carefully selected terms including Arabic technical terms, Islamic concepts, and methodological terminology
3. Description: 75-150 word thoughtful summary that honors Islamic scholarship while ensuring accessibility
4. Title Alias: Culturally sensitive English translation or alternative that maintains scholarly authenticity

Synthesis Guidelines:
- Apply Adab al-Ilm (Etiquette of Knowledge) in all descriptions
- Extract categories from Islamic intellectual traditions, genres, and methodologies
- Generate keywords with proper Arabic context and Islamic conceptual frameworks
- Create descriptions that respectfully introduce the work and explain its significance
- Produce title aliases that preserve scholarly dignity while improving searchability
- Maintain cultural sensitivity throughout while ensuring accessibility for diverse users

Return comprehensive structured JSON synthesis that honors Islamic scholarship and serves modern library catalog needs.`;
    ...
    return {
      ...
      synthesis_mission: 'Quality-focused transformation of mapper research into culturally sensitive library catalog fields (fallback mode)',
...
app.listen(PORT, () => {
  ...
  console.log(`📚 Mission: Quality-focused transformation of mapper research into culturally sensitive library catalog fields`);
  console.log(`🎯 Output: categories, keywords, description, title_alias for production library`);
  console.log(`🕌 Framework: Adab al-Ilm (Etiquette of Knowledge) with Islamic scholarly principles`);
  console.log(`🔗 Health check: http://localhost:${PORT}/health`);
  console.log(`⚡ Process books: http://localhost:${PORT}/process`);
  console.log('🧬 Enhancement: Culturally sensitive synthesis from Flowchart + Network Mapper research');
});